 ...
 */
export const checkObjectId = (oId: string): boolean => {
    if(ObjectId.isValid(oId)) return ((String)(new ObjectId(oId)) == oId);
    return false;
};
 ...
 */
export const checkArrayObjectId = (objectArray: Array<string>): boolean => {
