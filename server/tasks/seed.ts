...
// CREATE APPLICATIONS
    ...
    const oracle: ApplicationObject     = makeApplication(new ObjectId('624e26f4e01e9fe61478b5dd'), 'Oracle', 'https://logo.clearbit.com/oracle.com', 'Software Engineer', 'Austin, TX, USA', 130000, '#FF0000', 4, 'https://eeho.fa.us2.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1/requisitions/preview/159239/?keyword=Software+Engineer&location=United+States&locationId=300000000149325&locationLevel=country', `Oracle's Healthcare Group is looking for a Java backend software engineer to join a growing microservices platform team.  We want to bring order to chaos and develop world class software that provides a far superior user experience, and we're doing this at every step of the way. We're looking for someone that can complement our development team and expand our capacity to deliver.`);
